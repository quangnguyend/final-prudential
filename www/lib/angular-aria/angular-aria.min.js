...
*/
(function (s, q, t) {
  'use strict'; var f = 'BUTTON A INPUT TEXTAREA SELECT DETAILS SUMMARY'.split(' '), l = function (a, c) { if (c.indexOf(a[0].nodeName) !== -1) return !0 }; q.module('ngAria', ['ng']).provider('$aria', function () {
...
['$aria', function (a) { return a.$$watchExpr('ngRequired', 'aria-required', f, !1) }]).directive('ngModel', ['$aria', function (a) {
  function c (c, n, d, e) { return a.config(n) && !d.attr(c) && (e || !l(d, f)) } function m (a, c) { return !c.attr('role') && c.attr('type') === a && c[0].nodeName !== 'INPUT' } function h (a, c) { var d = a.type, e = a.role; return (d || e) === 'checkbox' || e === 'menuitemcheckbox' ? 'checkbox' : (d || e) === 'radio' || e === 'menuitemradio' ? 'radio' : d === 'range' || e === 'progressbar' || e === 'slider' ? 'range' : '' } return {restrict: 'A',
    require: 'ngModel',
    priority: 200,
    compile: function (f, n) {
      var d = h(n, f); return {pre: function (a, b, c, k) { d === 'checkbox' && (k.$isEmpty = function (a) { return !1 === a }) },
        post: function (e, b, g, k) {
          function f () { return k.$modelValue } function h (a) { b.attr('aria-checked', g.value == k.$viewValue) } function n () { b.attr('aria-checked', !k.$isEmpty(k.$viewValue)) } var l = c('tabindex', 'tabindex', b, !1); switch (d) {
            case 'radio':case 'checkbox':m(d, b) && b.attr('role', d); c('aria-checked', 'ariaChecked', b, !1) && e.$watch(f, d === 'radio' ? h : n); l && b.attr('tabindex', 0)
...
}).directive('ngClick', ['$aria', '$parse', function (a, c) { return {restrict: 'A', compile: function (m, h) { var p = c(h.ngClick, null, !0); return function (c, d, e) { if (!l(d, f) && (a.config('bindRoleForClick') && !d.attr('role') && d.attr('role', 'button'), a.config('tabindex') && !d.attr('tabindex') && d.attr('tabindex', 0), a.config('bindKeypress') && !e.ngKeypress))d.on('keypress', function (a) { function d () { p(c, {$event: a}) } var e = a.which || a.keyCode; e !== 32 && e !== 13 || c.$apply(d) }) } }} }]).directive('ngDblclick', ['$aria', function (a) {
  return function (c,
